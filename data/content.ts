...
export const projects: Project[] = [
  ...
  },
  {
    ...
    live: "",
    code: "https://github.com/sichanstha/NS-AERS",
...
export const about = {
  ...
  stats: [
    ...
    { icon: "code", value: projects.length, suffix: "", label: "Projects built or planned" },
    {
      icon: "users",
      value: projects.filter((p) => p.status.toLowerCase().includes("client")).length,
      suffix: "",
